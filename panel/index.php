...
?>
<!DOCTYPE html>
<html ng-app="scriptnet" ng-controller="panelControlador"  ng-init="user='<?php echo $user ?>'">
<head>
  <meta charset="UTF-8">
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no" name="viewport">
  <title>Panel &mdash; DRE</title>
  ...
  <script src="angular/lib/angular-sanitize.js"></script> 
  <script src="angular/lib/ui-bootstrap-tpls-2.5.0.min.js"></script>
  <!-- Controlador js -->
...
<body>
  ...
  <!-- <div id="app">
  <div class="load-bar" ng-show="load">
    <div class="bar"></div>
    <div class="bar"></div>
    <div class="bar"></div>
</div> -->
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block">Hola, <?php echo $user; ?></div></a>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="#/"><i class="fab fa-houzz"></i> <span> Inicio</span></a></li>
            <li class="menu-header">TITULADOS</li>
            <li><a class="nav-link" href="#/cargar/1"><i class="fas fa-cloud-upload-alt"></i> <span>Cargar</span></a></li>
